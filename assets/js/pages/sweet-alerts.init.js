...
/*
Template Name: Simple - Responsive Tailwind Admin Dashboard
Author: CoderThemes
Version: 2.0.0
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-warning').click(function () {
            Swal.fire({
                ...
                confirmButtonColor: "btn btn-success mt-2",
                cancelButtonColor: "btn btn-danger ml-2 mt-2",
        ...
        $('#sa-image').click(function () {
            Swal.fire({
                title: 'Sweet!',
                text: 'Responsive Admin Dashboard',
